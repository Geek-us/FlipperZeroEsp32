...
Canvas* canvas_init() {
    ...
    u8g2_esp32_hal.sda = 2;
    u8g2_esp32_hal.scl = 3;
    ...
    u8x8_SetI2CAddress(&(canvas->fb).u8x8, 0x78);
    u8g2_InitDisplay(&canvas->fb); // send init sequence to the display, display is in sleep mode after this,
