...
const GpioPin gpio_button_up = {.port = GPIOB, .pin = 26};
const GpioPin gpio_button_down = {.port = GPIOC, .pin = 15};
const GpioPin gpio_button_right = {.port = GPIOB, .pin = 28};
const GpioPin gpio_button_left = {.port = GPIOB, .pin = 27};
const GpioPin gpio_button_ok = {.port = GPIOH, .pin = 4};
...
const GpioPin gpio_i2c_power_sda = {.port = GPIOA, .pin = 2};
const GpioPin gpio_i2c_power_scl = {.port = GPIOA, .pin = 3};
...
//    furi_hal_bus_enable(FuriHalBusGPIOH);
    ...
    // TODO esp - commented out LL_* function calls
